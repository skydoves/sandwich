...
Sandwich has achieved an impressive milestone, being downloaded in __over 1,200,000__ Android projects worldwide! <br>
...
dependencies {
    ...
    implementation("com.github.skydoves:sandwich-retrofit:2.1.0") // For Retrofit (Android)
}
```
