 ...
 * @since 1.2.7
 *
 * Deserializes the Json string from error body of the [ApiResponse.Failure.Error] to the [T] custom type.
 * It returns `null` if the error body is empty.
 */
public inline fun <reified T> ApiResponse<T>.deserializeErrorBody(): T? {
